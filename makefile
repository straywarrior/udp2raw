...
COMMON=main.cpp lib/md5.cpp lib/pbkdf2-sha1.cpp lib/pbkdf2-sha256.cpp encrypt.cpp log.cpp network.cpp common.cpp  connection.cpp misc.cpp fd_manager.cpp client.cpp server.cpp fec/fec_manager.cpp fec/delay_manager.cpp fec/fec_adapter.cpp fec/lib/rs.cpp fec/lib/fec.cpp -lpthread
